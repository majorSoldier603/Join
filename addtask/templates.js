...
function generateHTMLNewCategory() {
  ...
  <div class="selection-img selection-img-activ" style="right: 15px;">
    <img onclick="cancelSection('category')" style="width: 20px; height: 20px;" class="img-24 px-5 cursor-p" src="../img/clear.svg" alt="cancel">
